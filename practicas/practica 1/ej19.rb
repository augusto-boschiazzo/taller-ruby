...
obj.instance_variable_set(:@var_nueva, "Otra variable de instancia") # Crea una nueva variable de instancia
puts "Variables de instancia de obj después de agregar una nueva:"
puts obj.instance_variables # Muestra la nueva variable de instancia